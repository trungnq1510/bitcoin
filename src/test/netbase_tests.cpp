...
{
    BOOST_CHECK(TestSplitHost("www.bitnamicoincore.org", "www.bitnamicoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitnamicoincore.org]", "www.bitnamicoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitnamicoincore.org:80", "www.bitnamicoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitnamicoincore.org]:80", "www.bitnamicoincore.org", 80));
