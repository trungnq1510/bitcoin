Bitnamicoin Core version 0.13.2 is now available from:

  <https://bitnamicoin.org/bin/bitnamicoin-core-0.13.2/>
...
- #8908 `4a974b2` Update bitnamicoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitnamicoin-tx to create v2 transactions (btcdrak)
