...
Bitnamicoin Core version 0.19.1 is now available from:

  <https://bitnamicoincore.org/bin/bitnamicoin-core-0.19.1/>
...
From Bitnamicoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Bitnamicoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Bitnamicoin Core does not yet change appearance when
...
- #17488 fix "bitnamicoind already running" warnings on macOS (fanquake)
