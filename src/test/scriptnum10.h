...
#ifndef BITNAMICOIN_TEST_SCRIPTNUM10_H
#define BITNAMICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitnamicoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITNAMICOIN_TEST_BIGNUM_H
