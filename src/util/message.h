...
#ifndef BITNAMICOIN_UTIL_MESSAGE_H
#define BITNAMICOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's bitnamicoin address, it must refer to a public key.
...
#endif // BITNAMICOIN_UTIL_MESSAGE_H
