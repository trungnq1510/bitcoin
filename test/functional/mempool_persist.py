...
By default, bitnamicoind will dump mempool on shutdown and
...
class MempoolPersistTest(BitnamicoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitnamicoind from writing mempool.dat to disk. Verify that `savemempool` fails")
