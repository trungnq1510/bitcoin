...
class VersionBitsWarningTest(BitnamicoinTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because bitnamicoind will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
