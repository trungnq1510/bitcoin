...
class TestShell:
    """Wrapper Class for BitnamicoinTestFramework.

    The TestShell class extends the BitnamicoinTestFramework
    ...
    class __TestShell(BitnamicoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitnamicoinTestFramework child class.
            self.num_nodes = 1
