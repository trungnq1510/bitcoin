...
#ifndef BITNAMICOIN_INTERFACES_NODE_H
#define BITNAMICOIN_INTERFACES_NODE_H
...
//! Top-level interface for a bitnamicoin node (bitnamicoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITNAMICOIN_INTERFACES_NODE_H
