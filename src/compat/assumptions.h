...
#ifndef BITNAMICOIN_COMPAT_ASSUMPTIONS_H
#define BITNAMICOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Bitnamicoin cannot be compiled without assertions."
#endif
...
#endif // BITNAMICOIN_COMPAT_ASSUMPTIONS_H
