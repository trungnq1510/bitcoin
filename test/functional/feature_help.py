...
"""Verify that starting bitnamicoin with -h works as expected."""

from test_framework.test_framework import BitnamicoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BitnamicoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitnamicoin with -h for help text")
        ...
        self.log.info("Start bitnamicoin with -version for version information")
        ...
        self.log.info("Start bitnamicoind with -fakearg to make sure it does not start")
