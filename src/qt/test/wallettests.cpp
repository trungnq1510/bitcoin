...
#include <qt/bitnamicoinamountfield.h>
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BitnamicoinAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_bitnamicoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_bitnamicoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_bitnamicoin-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = BitnamicoinUnits::formatWithUnit(unit, balance, false, BitnamicoinUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    BitnamicoinAmountField* amountInput = receiveCoinsDialog.findChild<BitnamicoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QCOMPARE(uri.count("bitnamicoin:"), 2);
