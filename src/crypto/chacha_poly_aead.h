...
#ifndef BITNAMICOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define BITNAMICOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitnamicoin.
 *
 ...
 *
 * The chacha20-poly1305@bitnamicoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitnamicoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitnamicoin are relatively fast in
...
#endif // BITNAMICOIN_CRYPTO_CHACHA_POLY_AEAD_H
