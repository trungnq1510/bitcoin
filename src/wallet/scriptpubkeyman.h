...
#ifndef BITNAMICOIN_WALLET_SCRIPTPUBKEYMAN_H
#define BITNAMICOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Bitnamicoin Core wallet was originally a collection of unrelated private
...
#endif // BITNAMICOIN_WALLET_SCRIPTPUBKEYMAN_H
