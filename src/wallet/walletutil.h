...
#ifndef BITNAMICOIN_WALLET_WALLETUTIL_H
#define BITNAMICOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitnamicoin from opening the wallet, thinking it was newly created, and
...
#endif // BITNAMICOIN_WALLET_WALLETUTIL_H
