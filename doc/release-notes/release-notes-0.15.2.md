Bitnamicoin Core version *0.15.2* is now available from:

  <https://bitnamicoincore.org/bin/bitnamicoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitnamicoin-tx (TheBlueMatt)
