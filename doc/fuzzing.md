# Fuzzing Bitnamicoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Bitnamicoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):

```sh
$ git clone https://github.com/bitnamicoin/bitnamicoin
$ cd bitnamicoin/
$ ./autogen.sh
$ CC=clang CXX=clang++ ./configure --enable-fuzz --with-sanitizers=address,fuzzer,undefined
# macOS users: If you have problem with this step then make sure to read "macOS hints for
# libFuzzer" on https://github.com/bitnamicoin/bitnamicoin/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/bitnamicoin/bitnamicoin/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/bitnamicoin/bitnamicoin/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/bitnamicoin/bitnamicoin/tree/master/src/test/fuzz).
...
The project's collection of seed corpora is found in the [`bitnamicoin-core/qa-assets`](https://github.com/bitnamicoin-core/qa-assets) repo.

To fuzz `process_message` using the [`bitnamicoin-core/qa-assets`](https://github.com/bitnamicoin-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/bitnamicoin-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`bitnamicoin-core/qa-assets`](https://github.com/bitnamicoin-core/qa-assets) repo.

Every single pull request submitted against the Bitnamicoin Core repo is automatically tested against all inputs in the [`bitnamicoin-core/qa-assets`](https://github.com/bitnamicoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Bitnamicoin Core more robust.
...
with certain assembly code from Bitnamicoin Core's code. See [developer notes on sanitizers](https://github.com/bitnamicoin/bitnamicoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Bitnamicoin Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Bitnamicoin Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing Bitnamicoin Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Bitnamicoin Core using [Honggfuzz](https://github.com/google/honggfuzz):
