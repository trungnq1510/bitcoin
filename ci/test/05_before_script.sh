...
if [ "$TRAVIS_OS_NAME" == "osx" ]; then
  echo > $HOME/Library/Application\ Support/Bitnamicoin
else
  DOCKER_EXEC echo \> \$HOME/.bitnamicoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/bitnamicoin/bitnamicoin/pull/18288#discussion_r433189350 for
  # details.
