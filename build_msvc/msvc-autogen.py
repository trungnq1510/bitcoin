...
libs = [
    'libbitnamicoin_cli',
    'libbitnamicoin_common',
    'libbitnamicoin_crypto',
    'libbitnamicoin_server',
    'libbitnamicoin_util',
    'libbitnamicoin_wallet_tool',
    'libbitnamicoin_wallet',
    'libbitnamicoin_zmq',
    'bench_bitnamicoin',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='Bitnamicoin-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/bitnamicoin_config.h'), os.path.join(SOURCE_DIR, 'config/bitnamicoin-config.h'))
