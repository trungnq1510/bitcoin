Bitnamicoin Core version 0.10.4 is now available from:

  <https://bitnamicoin.org/bin/bitnamicoin-core-0.10.4/>
...
- #6953 `43c2789` Split bitnamicoin-tx into its own package
- #6953 `dfe0d4d` Include bitnamicoin-tx binary on Debian/Ubuntu
