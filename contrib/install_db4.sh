...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitnamicoin repository."
  exit 1
fi
...
# See https://github.com/bitnamicoin/bitnamicoin/issues/16064
...
echo 'When compiling bitnamicoind, run `./configure` in the following way:'
echo
