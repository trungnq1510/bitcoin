...
class P2PPermissionsTests(BitnamicoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bitnamicoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bitnamicoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
