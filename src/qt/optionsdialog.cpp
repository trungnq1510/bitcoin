    ...
    mapper(nullptr)
{
    ...
    ui->bitnamicoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitnamicoinAtStartup);
    ...
    ui->bitnamicoinAtStartup->setToolTip(ui->bitnamicoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitnamicoinAtStartup->setText(ui->bitnamicoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitnamicoinConfButton->setToolTip(ui->openBitnamicoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitnamicoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitnamicoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitnamicoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitnamicoinConf())
