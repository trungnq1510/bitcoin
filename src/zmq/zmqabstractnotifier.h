// Copyright (c) 2015-2018 The Bitnamicoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITNAMICOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
#define BITNAMICOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // BITNAMICOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
