...
#ifndef BITNAMICOIN_UTIL_SETTINGS_H
#define BITNAMICOIN_UTIL_SETTINGS_H
...
//!       https://github.com/bitnamicoin/bitnamicoin/pull/15934/files#r337691812)
...
#endif // BITNAMICOIN_UTIL_SETTINGS_H
