...
// bitnamicoin includes.
#include <..\src\script\bitnamicoinconsensus.h>
...
int main()
{
    std::cout << "bitnamicoinconsensus version: " << bitnamicoinconsensus_version() << std::endl;
    ...
    auto op0Result = bitnamicoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bitnamicoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
