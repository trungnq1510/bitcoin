Bitnamicoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitnamicoin/files/Bitnamicoin/bitnamicoin-0.5.4/
...
http://gitorious.org/bitnamicoin/bitnamicoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitnamicoin-Qt notifications under Growl 1.3.
Increase required age of Bitnamicoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitnamicoin properly when installing Bitnamicoin-Qt over it. (Windows)
