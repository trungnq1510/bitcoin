Bitnamicoin Core version 0.16.1 is now available from:

  <https://bitnamicoincore.org/bin/bitnamicoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitnamicoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitnamicoind processes are cleaned up when tests end (sdaftuar)
