Bitnamicoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitnamicoin/files/Bitnamicoin/bitnamicoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitnamicoin
...
New/changed settings (command-line or bitnamicoin.conf file)
--------------------------------------------------------
