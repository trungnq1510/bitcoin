...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitnamicoinTestFramework
    pass


class ExampleTest(BitnamicoinTestFramework):
    # Each functional test is a subclass of the BitnamicoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BitnamicoinTestFramework class so other tests can use it."""
