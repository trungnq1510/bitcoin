...
# TestP2PConn: A peer we use to send messages to bitnamicoind, and store responses.
...
class CompactBlocksTest(BitnamicoinTestFramework):
    ...
    # This test actually causes bitnamicoind to (reasonably!) disconnect us, so do this last.
    ...
    # bitnamicoind's choice of nonce.
    ...
    # Test that bitnamicoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bitnamicoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # bitnamicoind will not send blocktxn responses for blocks whose height is
