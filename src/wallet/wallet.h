...
#ifndef BITNAMICOIN_WALLET_WALLET_H
#define BITNAMICOIN_WALLET_WALLET_H
...
public:
     ...
     * on this bitnamicoin node, and set to 0 for transactions that were created
...
#endif // BITNAMICOIN_WALLET_WALLET_H
