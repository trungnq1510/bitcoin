...
#ifndef BITNAMICOIN_QT_WALLETMODEL_H
#define BITNAMICOIN_QT_WALLETMODEL_H
...
/** Interface to Bitnamicoin wallet from Qt view code. */
...
#endif // BITNAMICOIN_QT_WALLETMODEL_H
