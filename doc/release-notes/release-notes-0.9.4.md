Bitnamicoin Core version 0.9.4 is now available from:

  https://bitnamicoin.org/bin/0.9.4/
...
this update is incompatible with the Bitnamicoin system and could lead to consensus
forks.

Bitnamicoin Core released binaries from https://bitnamicoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitnamicoin/+archive/ubuntu/bitnamicoin
- A third-party or self-compiled Bitnamicoin Core

upgrade to Bitnamicoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
